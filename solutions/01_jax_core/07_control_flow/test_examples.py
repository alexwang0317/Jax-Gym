"""
Tests for JAX Control Flow Examples
===================================
"""
...
from examples import (
    ...
    example_while_loop,
    example_fori_loop,
    example_nested_control_flow,
    example_control_flow_grad,
    example_python_vs_jax,
    example_lax_select,
...
class TestNestedControlFlow:
    def test_nested_cond(self):
        result = example_nested_control_flow()
...
class TestControlFlowGrad:
    def test_branch_gradients(self):
        result = example_control_flow_grad()
