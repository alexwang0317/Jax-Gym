"""
Tests for Optax Basic Optimizers Exercises
==========================================
"""
...
from exercises import (
    exercise_sgd,
    exercise_sgd_momentum,
    exercise_adam,
    exercise_adamw,
    exercise_rmsprop,
    exercise_adagrad,
    exercise_chain,
    exercise_apply_updates,
    exercise_state_inspection,
    exercise_custom_optimizer,
)
