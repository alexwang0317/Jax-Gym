...
from exercises import (
    exercise_basic_vmap,
    exercise_in_out_axes,
    exercise_multiple_args,
    exercise_nested_vmap,
    exercise_vmap_jit,
    exercise_vmap_grad,
    exercise_matrix_vector,
    exercise_pairwise_distances,
    exercise_none_axes,
    exercise_attention_scores,
)


class TestBasicVmap:
    def test_results_match(self):
        result = exercise_basic_vmap()
...
class TestPairwiseDistances:
    def test_methods_match(self):
        result = exercise_pairwise_distances()
...
class TestAttentionScores:
    def test_single_head_shape(self):
        result = exercise_attention_scores()
